...
static MDIN_ERROR_t MDIN3xx_SetSrcVideoCSC(PMDIN_VIDEO_INFO pINFO)
{
	...
	if (pINFO->macro_mode == 1) {
		//printf("[%s:%d] This is macro mode!!!!\n", __FILE__, __LINE__);
		...
		if (pOUT->stATTB.attb&MDIN_COLORSPACE_YUV) {
			if (pOUT->stATTB.attb&MDIN_QUALITY_HD) {
				 if (pINFO->macro_mode == 1) {
					 ...
					 //pCSC = (PMDIN_CSCCTRL_INFO)&MDIN_CscSDtoHD_StdRange;	// RGB or YUV(SD) to YUV(HD)
					 pCSC = (PMDIN_CSCCTRL_INFO)&MDIN_CscHDtoSD_StdRange;	// RGB or YUV(HD) to YUV(SD)
					 //pCSC = (PMDIN_CSCCTRL_INFO)&MDIN_CscBypass_FullRange;
					 //pCSC = (PMDIN_CSCCTRL_INFO)&MDIN_CscBypass_RemoveBlack_StdRange;
				 }

				 //printf("[%s:%d] CscBypass_StdRange!!!!!\n", __FILE__, __LINE__);
			}
			else pCSC = (PMDIN_CSCCTRL_INFO)&MDIN_CscHDtoSD_StdRange;	// RGB or YUV(HD) to YUV(SD)
		}
		else {
...
//--------------------------------------------------------------------------------------------------------------------------
MDIN_ERROR_t MDIN3xx_SetOut4CH_OutBT656(void)	
{
