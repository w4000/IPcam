...
*/
extern UINT32      kflow_dis_get_prvmaxBuffer(void);
...
/**
    ...
    @return VOID.
*/
extern void        kflow_dis_initialize(DIS_IPC_INIT *p_buf);
...
/**
    ...
    @return VOID.
*/
extern void        kflow_dis_end(void);
...
/**
    ...
    @return HD_RESULT,HD_OK for ok. other for error.
*/
extern ER         kflow_dis_process(void);
/**
    process the dis_alg without compensation, need set disinfor firstly.
    @return HD_RESULT,HD_OK for ok. other for error.
*/
extern ER         kflow_dis_process_no_compen_info(void);
...
/**
    ...
    @return HD_RESULT,HD_OK for ok. other for error.
*/
extern ER          kflow_dis_set_disinfor(DIS_PARAM *p_disinfo);
...
*/
extern BOOL        kflow_dis_set_blksize(DIS_BLKSZ blksz);
...
/**
    ...
    @return VOID.
*/
extern void        kflow_dis_get_input_info(DIS_PARAM *p_info);
...
*/
extern DIS_BLKSZ   kflow_dis_get_blksize_info(void);
...
*/
extern DIS_MDS_DIM kflow_dis_get_mds_dim(void);
...
*/
extern UINT32      kflow_dis_get_trigger_status(void);
...
/**
    ...
    @return VOID.
*/
extern void       kflow_dis_push_time_stamp(UINT64 time_stamp, UINT32 frame_count); // Set time_stamp using frame_count as the index. Pushing if there is a matched counter else discarding the time-stamp.
...
*/
extern UINT64     kflow_dis_get_ready_motionvec(DIS_MV_INFO_SIZE *p_mvinfo_size);	  // Retrieve the newest valid motion vectors and time stamp.  Return time stamp (-1 if failed)
...
extern BOOL             kflow_dis_set_only_mv(UINT32 dis_only_proc_mv);
extern UINT32           kflow_dis_get_only_mv(void);

extern DIS_SUBSEL       kflow_dis_get_subin_info(void);
extern BOOL             kflow_dis_set_subin(DIS_SUBSEL subsel);
