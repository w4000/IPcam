...
typedef struct {
	...
	MP_JPEG_BRC_PARAM           JpegBrc;                //in: jpeg brc
#ifdef VDOENC_LL
	...
	BOOL                        bTimerTrigComp;			//in: timmer trigger compensation
} NMR_VDOENC_OBJ;
...
extern SEM_HANDLE _SECTION(".kercfg_data") NMR_VDOENC_SLICE_ENC_SEM_ID[];
