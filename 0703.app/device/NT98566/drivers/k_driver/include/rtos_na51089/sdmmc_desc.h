...
typedef struct {
	...
	UINT8   ucHSTiming;                  // [185]     0x0: backwards, 0x1: HS, 0x2: HS200, 0x3: HS400
	UINT8   ucStrobeSupport;             // [184]     0x0: no support, 0x1: support enhanced strobe mode
	UINT8   ucUserProt;                  // [171]     User area write protection register
	UINT8   ucCIDCSDDdrSupport;          // [130:0]   This field indicates if the CMD26 and CMD27 are supported in dual data rate mode by the device
