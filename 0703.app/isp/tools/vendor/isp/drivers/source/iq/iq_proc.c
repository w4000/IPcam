...
static INT32 iq_proc_command_show(struct seq_file *sfile, void *v)
{
	...
	if (iq_proc_r_item == IQ_PROC_R_ITEM_PARAM) {
		...
		// iq_shdr_param
		seq_printf(sfile, "====================id(%d) iq_shdr_ext_param==================== \r\n", iq_proc_id);
		seq_printf(sfile, "fusion_diff_w = %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, \r\n"
			, iq_param[iq_proc_id]->shdr_ext->fcurve_y_w_lut[0], iq_param[iq_proc_id]->shdr_ext->fcurve_y_w_lut[1]
			, iq_param[iq_proc_id]->shdr_ext->fcurve_y_w_lut[2], iq_param[iq_proc_id]->shdr_ext->fcurve_y_w_lut[3]
			, iq_param[iq_proc_id]->shdr_ext->fcurve_y_w_lut[4], iq_param[iq_proc_id]->shdr_ext->fcurve_y_w_lut[5]
			, iq_param[iq_proc_id]->shdr_ext->fcurve_y_w_lut[6], iq_param[iq_proc_id]->shdr_ext->fcurve_y_w_lut[7]
			, iq_param[iq_proc_id]->shdr_ext->fcurve_y_w_lut[8], iq_param[iq_proc_id]->shdr_ext->fcurve_y_w_lut[9]
			, iq_param[iq_proc_id]->shdr_ext->fcurve_y_w_lut[10], iq_param[iq_proc_id]->shdr_ext->fcurve_y_w_lut[11]
			, iq_param[iq_proc_id]->shdr_ext->fcurve_y_w_lut[12], iq_param[iq_proc_id]->shdr_ext->fcurve_y_w_lut[13]
			, iq_param[iq_proc_id]->shdr_ext->fcurve_y_w_lut[14], iq_param[iq_proc_id]->shdr_ext->fcurve_y_w_lut[15]
			, iq_param[iq_proc_id]->shdr_ext->fcurve_y_w_lut[16]);
		...
		// iq_cst_param
		seq_printf(sfile, "====================id(%d) iq_cst_param==================== \r\n", iq_proc_id);
		seq_printf(sfile, "cst_coef = %d, %d, %d, %d, %d, %d, %d, %d, %d, \r\n"
