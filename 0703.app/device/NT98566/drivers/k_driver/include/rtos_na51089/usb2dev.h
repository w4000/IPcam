...
/**
    ...
    @return
        ...
        - @b TRUE: Plug State.
*/
extern void                 usb2dev_reset_fifo_config(void);
...
/**
    Set USB device in high speed/full speed mode.

    @note If this function is not called to set the desired USB speed, USB
        will be hardware default to high speed. This function should
        be called before USB is enabled.\n
        It is suggested to set high/full speed by usb_PowerOnInit().

    @param[in] bHighSpeed   High speed or Full speed
                            - @b TRUE: Enable high speed
                            - @b FALSE: Disable high speed (Full speed only)
    @return void
*/
extern void usb2dev_EnableHighSpeed(BOOL bHighSpeed);
...
/**
    ...
    @return
        ...
        - @b FALSE: device is in full speed
*/
extern BOOL usb2dev_isHighSpeedEnabled(void);


/**
    Get the current role of USB.

    @return
        - @b TRUE: usb device
        - @b FALSE: usb host
*/
extern BOOL usb2dev_CurrentRole(void);
...
/**
    ...
    @return void
*/
extern void usb2dev_SetDevDescUSBVerRelNum(BOOL Speed, UINT16 RelNum);


/*
    Cx Data loop back test

    (Engineer Usage)

    This function is used for module test. It will not send real
    data to USB bus, only loop back inside controller.

    @return
        - @b TRUE: loop back test success
        - @b FALSE: loop back test fail
*/
extern BOOL usb2dev_CxLoopbackTest(void);
