...
*/
#ifndef _KFLOW_ETH_ALG_H_
#define _KFLOW_ETH_ALG__H_
...
ER kflow_dis_eth_set_in_param_info(UINT32 id, void* p_data);
ER kflow_dis_eth_set_dma_out(UINT32 id, void* p_data);
ER kflow_dis_eth_get_in_param_info(UINT32 id, void* p_data);
ER kflow_dis_eth_get_dma_out(UINT32 id, void* p_data);
ER kflow_dis_eth_get_out_info(UINT32 id, void* p_data);
