...
#define IDE_DUMP          DISABLE
#define IDE_CHK_ADDR      DISABLE
...
*/
//@{
#define DBG_CON_DUMP_BUF      FLGPTN_BIT(0)   //continue dump buffer.
#define DBG_DUMP_VD           FLGPTN_BIT(1)   //dump vd
#define DBG_VALUE_SHIFT       (24)
#define DBG_VALUE_MASK        0xFF000000
//@}
...
typedef struct _VDODISP_DBGINFO {
	...
	UINT32         reserved;          ///< for debug control
} VDODISP_DBGINFO;
