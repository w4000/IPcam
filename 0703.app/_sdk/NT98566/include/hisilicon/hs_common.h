...
typedef enum sample_vi_mode_e
{
    ...
    JX_F22_MIPI_1080P_20FPS,
    SMARTSENS_SC2235_CMOS_1080P_20FPS,
...
HI_S32 SAMPLE_COMM_VI_CORRECTION_CONFIG(const char* fpn_file,     /* fpn file_name */
                                        ...
                                        PIXEL_FORMAT_E enPixelFormat);
HI_S32 SAMPLE_COMM_VI_ChangeFlipMode(VI_CHN ViChn, int* pbMirror, int* pbFlip);
...
HI_S32 SAMPLE_COMM_VENC_Start(ENCODE_INFO* pEncodeInfo, VENC_CHN VencChn, PAYLOAD_TYPE_E enType, VIDEO_NORM_E enNorm, PIC_SIZE_E enSize, SAMPLE_RC_E enRcMode, HI_U32 u32Profile, ROTATE_E enRotate, HI_BOOL qpmap);
HI_S32 SAMPLE_COMM_VENC_StartEx(ENCODE_INFO* pEncodeInfo, VENC_CHN VencChn, PAYLOAD_TYPE_E enType, VIDEO_NORM_E enNorm, PIC_SIZE_E enSize, SAMPLE_RC_E enRcMode, HI_U32  u32Profile, VENC_GOP_ATTR_S *pstGopAttr);
...
HI_S32 SAMPLE_COMM_VENC_StartGetStream(ENCODE_INFO* pEncodeInfo, HI_S32 s32Cnt);
...
HI_S32 SAMPLE_COMM_AUDIO_CreatTrdAencAdec(ENCODE_INFO *pEncodeInfo, AENC_CHN AeChn, ADEC_CHN AdChn);
