...
extern void awb_flow_get_win(struct seq_file *sfile, AWB_ID id);
extern void awb_flow_set_win(AWB_ID id, UINT32 mode);
...
extern ER awbt_api_nnsc_get_cmd(AWBT_ITEM item, UINT32 addr);
extern ER awbt_api_nnsc_set_cmd(AWBT_ITEM item, UINT32 addr);
