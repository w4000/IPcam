...
static void md_set_para_default_sensitivity(VENDOR_MD_PARAM *mdbc_parm)
{
	...
	mdbc_parm->UpdPara.va_distth      = 0;
	mdbc_parm->UpdPara.t_distth       = 0;
	mdbc_parm->UpdPara.dbg_frmID      = 0x0;
	mdbc_parm->UpdPara.dbg_frmID_en   = 0x0;
	mdbc_parm->UpdPara.dbg_rnd        = 0x56AE;
	mdbc_parm->UpdPara.dbg_rnd_en     = 0x1;
}
...
*/
	...
	mdt_lib_param.mdt_cross_param.blk1_y = IMG_HEIGHT / 2;
	mdt_lib_param.mdt_cross_param.blk2_x = 0;
	mdt_lib_param.mdt_cross_param.blk2_y = IMG_HEIGHT / 2;
	mdt_lib_param.mdt_cross_param.blk3_x = IMG_WIDTH;
	mdt_lib_param.mdt_cross_param.blk3_y = IMG_HEIGHT / 2;
	mdt_lib_param.mdt_cross_param.blk4_x = IMG_WIDTH;
	mdt_lib_param.mdt_cross_param.blk4_y = IMG_HEIGHT / 2;

	/*mdt_lib_param.mdt_cross_param.cross_type = 2;			//  none:0 cross_Entrance:1 cross_region:2
	mdt_lib_param.mdt_cross_param.overlap_th = 1;			//  object overlapping threshold
	mdt_lib_param.mdt_cross_param.blk1_x = 0;				//left-top
	mdt_lib_param.mdt_cross_param.blk1_y = IMG_HEIGHT*2/5;
	mdt_lib_param.mdt_cross_param.blk2_x = IMG_WIDTH;		//right-top
	mdt_lib_param.mdt_cross_param.blk2_y = IMG_HEIGHT*2/5;
	mdt_lib_param.mdt_cross_param.blk3_x = IMG_WIDTH;		//right-down
	mdt_lib_param.mdt_cross_param.blk3_y = IMG_HEIGHT*3/5;
	mdt_lib_param.mdt_cross_param.blk4_x = 0;				//left-down
	mdt_lib_param.mdt_cross_param.blk4_y = IMG_HEIGHT*3/5;*/
			...
			if (lib_md_rst.obj_num > 0) {
				for (obj_counter = 1; obj_counter <= lib_md_rst.obj_num; obj_counter++) {
					if (mdt_lib_param.mdt_enable.md_obj_cross_en == 1) {
						printf("[OBJ %d]: x0=%d,x1=%d,y0=%d,y1=%d,cross_rst=%d\r\n", obj_counter,
							lib_md_rst.obj[obj_counter].start_x, lib_md_rst.obj[obj_counter].end_x,
							lib_md_rst.obj[obj_counter].start_y, lib_md_rst.obj[obj_counter].end_y, lib_md_rst.obj[obj_counter].cross_rst);
					}
					else {
