...
typedef struct {
	...
	UINT8   gain_enable;                            // gain enable/disable
	UINT8   slop;                                   // 0~15 fisheye gain decrease slope out of radius
	UINT32  radius;                                 // 0~1023, fisheye gain radius
} KDRV_IFE_VIG_PARAM;
