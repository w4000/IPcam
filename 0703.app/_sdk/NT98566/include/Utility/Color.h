...
#define COLOR_RGB444_GET_COLOR(c)   (COLOR_ITEM)(((c) & 0x00000fff) >> 0) ///< get RGB channel value of ARGB4444 color
#define COLOR_RGB444_GET_A(c)       (CVALUE)(((c) & 0x0000f000) >> 12) ///< get A channel value of ARGB4444 color
#define COLOR_RGB444_GET_B(c)       (CVALUE)(((c) & 0x00000004) >> 0)  ///< get B channel value of ARGB4444 color
#define COLOR_RGB444_GET_G(c)       (CVALUE)(((c) & 0x000000f0) >> 4)  ///< get G channel value of ARGB4444 color
#define COLOR_RGB444_GET_R(c)       (CVALUE)(((c) & 0x00000f00) >> 8)  ///< get R channel value of ARGB4444 color
