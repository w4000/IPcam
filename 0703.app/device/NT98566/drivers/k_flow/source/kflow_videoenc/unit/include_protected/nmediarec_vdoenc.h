...
typedef enum {
	...
	NMI_VDOENC_PARAM_BS_AVAILABLE_HEIGHT,
	...
	NMI_VDOENC_PARAM_JPG_BRC,
	NMI_VDOENC_PARAM_H26X_EVBR_STATE,
...
#endif
	BOOL   enc_slice_en;                        ///< enable slice mode
	UINT32 slice_cnt;							///< slice index
