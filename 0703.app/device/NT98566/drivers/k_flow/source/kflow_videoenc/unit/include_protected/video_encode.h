...
typedef struct {
	...
	UINT16  slice_cnt;                                  ///< slice count, use for UVC
	UINT16  slice_idx;                                  ///< slice index, use for UVC
	UINT16  jpeg_slice_cnt;                             ///< slice count, use for CARDV
	UINT16  jpeg_slice_idx;                             ///< slice index, use for CARDV
} MP_VDOENC_YUV_SRC;
...
typedef KDRV_JPEG_BRC_PARAM MP_JPEG_BRC_PARAM; 
