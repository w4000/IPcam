...
#define FLG_ID_WAVSTUD_STS_ISR_IDLE     0x80000000
#define FLG_ID_WAVSTUD_STS_ISR_IDLE2    0x00000020
//@}
...
#define FLG_ID_WAVSTUD_STS              (FLG_ID_WAVSTUD_STS_GOING   | \
		...
		FLG_ID_WAVSTUD_STS_ISR_IDLE | \
		FLG_ID_WAVSTUD_STS_ISR_IDLE2)
...
typedef struct _WAVSTUD_ACT_OBJ {
	...
	BOOL (*fpDataCB)(PAUDIO_BUF_QUEUE p_aud_bufque, PAUDIO_BUF_QUEUE p_aud_bufque_aec, UINT32 id, UINT64 timestamp, UINT64 timestamp_aec);
...
typedef struct _WAVSTUD_OBJ {
	...
	INT32                alc_en;
	UINT32               rec_src;
	UINT32               rec_gain_level;
	UINT32               alc_decay_time;
	UINT32               alc_attack_time;
	INT32                alc_max_gain;
	INT32                alc_min_gain;
	INT32                alc_cfg_en;
...
extern UINT32 WavStud_GetTmpSize(AUDIO_SR audSR, UINT32 ch_num, WAVSTUD_BITS_PER_SAM bps);
