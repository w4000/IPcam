...
typedef struct {
	...
	BOOL    gain_enable;								///< range: 0~1   , gain enable/disable
	UINT8   slop;										///< range: 0~15  , fisheye gain decrease slope out of radius
	UINT32  radius;										///< range: 0~1023, fisheye gain radius
} CTL_IFE_ISP_VIG;
