...
UINT32 _EFUSE_BASE_ADDR;
UINT32 _CG_BASE_ADDR;
...
void sie_platform_create_resource(void)
{
	...
	_EFUSE_BASE_ADDR = 0xF0660074;
	_CG_BASE_ADDR = 0xF0020000;
...
void sie_platform_create_resource(SIE_MODULE_INFO *pmodule_info)
{
	...
	_EFUSE_BASE_ADDR = (UINT32)pmodule_info->ext_io_addr0;
	_CG_BASE_ADDR = (UINT32)pmodule_info->ext_io_addr1;
