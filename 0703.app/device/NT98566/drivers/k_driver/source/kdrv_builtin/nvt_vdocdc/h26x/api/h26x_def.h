...
0.3.10(2021/05/31): provide maq diff api
0.3.11(2022/01/20): update H265 header: support ltr_interval = 1
0.3.12(2022/02/25): support gdr in i frame
*/

#define NVT_H26XENC_VERSION     0x00030b00
