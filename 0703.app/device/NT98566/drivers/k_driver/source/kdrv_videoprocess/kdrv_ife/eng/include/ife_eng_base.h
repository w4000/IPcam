...
/**
    IFE dma wait SIE2 frame start disable define 
*/
//@{
typedef enum {
	IFE_DMA_WAIT_SIE2_FRM_ST       = 0,       ///< disable=0, dma wait SIE2 frame start
	IFE_DMA_NO_WAIT_SIE2_FRM_ST    = 1,       ///< disable=1, don't wait SIE2 frame start
	ENUM_DUMMY4WORD(IFE_DMA_WAIT_SIE2_FRM_START_DISABLE)
} IFE_DMA_WAIT_SIE2_FRM_START_DISABLE;
