...
typedef struct _KFLOW_AI_JOB {
	...
	UINT32 ts_exec_end;
	UINT32 ts_exec_predict;   // ideal_cycle / div
	UINT32 ts_exec_ideal_cycle;
	UINT32 ts_exec_cycle;
	UINT32 debug_func;
	//runtime func
...
#endif
	UINT32 ts_perf_begin;
	UINT32 ts_perf_end;
	UINT32 ts_exec;
	UINT32 ts_exec_hw;
	UINT32 ts_exec_ideal;
	UINT64 lts_exec_all;
	UINT64 lts_exec;
...
extern void kflow_ai_perf(UINT32 func);
//clr/set job
