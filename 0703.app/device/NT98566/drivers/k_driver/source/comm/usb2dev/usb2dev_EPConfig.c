...
BOOL usb_abortDMA(USB_EP EPn, USB_DMACH DmaCH)
{
	...
	UINT32                        uiRegOfs, i, j, loop_cnt = 0;
	FLGPTN                        uiFlag = 0;
		...
		if ((DmaCH & (0x1 << i)) && devDMACtrl.bit.VDMA_START_CXF) {
			...
			*/
...

			{
				...
				FIFOCfgReg.reg = USB_GETREG(USB_DEVFIFOCFG_REG_OFS);
				/*Ping-pong fifo case, reset fifo 0-11*/
				if ((i == 0) && (FIFOCfgReg.bit.PINGPONG0 == 1)) {
					for (j = 0; j < 12; j++) {
						if (j < 4) {
							devFIFOByteCnt.reg  = USB_GETREG(USB_DEVFIFO0BYTECNT_REG_OFS + (j << 2));
							devFIFOByteCnt.bit.FFRST = 0x1;
							USB_SETREG(USB_DEVFIFO0BYTECNT_REG_OFS + (j << 2), devFIFOByteCnt.reg);
						} else {
							devFIFOByteCnt.reg  = USB_GETREG(USB_DEVFIFO4BYTECNT_REG_OFS + ((j - USB_FIFO4) << 2));
							devFIFOByteCnt.bit.FFRST = 0x1;
							USB_SETREG(USB_DEVFIFO4BYTECNT_REG_OFS + ((j - USB_FIFO4) << 2), devFIFOByteCnt.reg);
						}
					}
				}
			}
	...
	/*Clear FIFO if dma is done*/
	{
		...
		T_USB_DEVFIFOCFG2_REG	 FIFOCfg2Reg;
		T_USB_DEVFIFOCFG3_REG	 FIFOCfg3Reg;
		UINT32 fifo_num = gEPMap[EPn - 1];
		j = 0;

		switch (fifo_num) {
		case USB_FIFO0: {
				FIFOCfgReg.reg = USB_GETREG(USB_DEVFIFOCFG_REG_OFS);
				if (FIFOCfgReg.bit.PINGPONG0 == 1)
					j = 12;
				else if ((FIFOCfgReg.bit.BLKNO_F0 == 0) && (FIFOCfgReg.bit.BLKSZ_F0))
					j = 2;
				else if ((FIFOCfgReg.bit.BLKNO_F0 == 1) && (FIFOCfgReg.bit.BLKSZ_F0))
					j = 4;
				else if (FIFOCfgReg.bit.BLKNO_F0 == 1)
					j = 2;
				else if (FIFOCfgReg.bit.BLKNO_F0 == 2)
					j = 3;
				else
					j = 1;
			}
		...
		case USB_FIFO1: {
				FIFOCfgReg.reg = USB_GETREG(USB_DEVFIFOCFG_REG_OFS);
				if ((FIFOCfgReg.bit.BLKNO_F1 == 0) && (FIFOCfgReg.bit.BLKSZ_F1))
					j = 2;
				else if ((FIFOCfgReg.bit.BLKNO_F1 == 1) && (FIFOCfgReg.bit.BLKSZ_F1))
					j = 4;
				else if (FIFOCfgReg.bit.BLKNO_F1 == 1)
					j = 2;
				else if ((FIFOCfgReg.bit.BLKNO_F1 == 2) && (FIFOCfgReg.bit.BLKSZ_F1))
					j = 6;
				else if (FIFOCfgReg.bit.BLKNO_F1 == 2)
					j = 3;
				else
					j = 1;
			}
		...
		case USB_FIFO2: {
				FIFOCfgReg.reg = USB_GETREG(USB_DEVFIFOCFG_REG_OFS);
				if ((FIFOCfgReg.bit.BLKNO_F2 == 0) && (FIFOCfgReg.bit.BLKSZ_F2))
					j = 2;
				else if ((FIFOCfgReg.bit.BLKNO_F2 == 1) && (FIFOCfgReg.bit.BLKSZ_F2))
					j = 4;
				else if (FIFOCfgReg.bit.BLKNO_F2 == 1)
					j = 2;
				else if ((FIFOCfgReg.bit.BLKNO_F2 == 2) && (FIFOCfgReg.bit.BLKSZ_F2))
					j = 6;
				else if (FIFOCfgReg.bit.BLKNO_F2 == 2)
					j = 3;
				else
					j = 1;
			}
		...
		case USB_FIFO3: {
				FIFOCfgReg.reg = USB_GETREG(USB_DEVFIFOCFG_REG_OFS);
				if ((FIFOCfgReg.bit.BLKNO_F3 == 0) && (FIFOCfgReg.bit.BLKSZ_F3))
					j = 2;
				else if ((FIFOCfgReg.bit.BLKNO_F3 == 1) && (FIFOCfgReg.bit.BLKSZ_F3))
					j = 4;
				else if (FIFOCfgReg.bit.BLKNO_F3 == 1)
					j = 2;
				else if ((FIFOCfgReg.bit.BLKNO_F3 == 2) && (FIFOCfgReg.bit.BLKSZ_F3))
					j = 6;
				else if (FIFOCfgReg.bit.BLKNO_F3 == 2)
					j = 3;
				else
					j = 1;
			}
		...
		case USB_FIFO4: {
				FIFOCfg1Reg.reg = USB_GETREG(USB_DEVFIFOCFG1_REG_OFS);
				if ((FIFOCfg1Reg.bit.BLKNO_F4 == 0) && (FIFOCfg1Reg.bit.BLKSZ_F4))
					j = 2;
				else if ((FIFOCfg1Reg.bit.BLKNO_F4 == 1) && (FIFOCfg1Reg.bit.BLKSZ_F4))
					j = 4;
				else if (FIFOCfg1Reg.bit.BLKNO_F4 == 1)
					j = 2;
				else if ((FIFOCfg1Reg.bit.BLKNO_F4 == 2) && (FIFOCfg1Reg.bit.BLKSZ_F4))
					j = 6;
				else if (FIFOCfg1Reg.bit.BLKNO_F4 == 2)
					j = 3;
				else
					j = 1;
			}
		...
		case USB_FIFO5: {
				FIFOCfg1Reg.reg = USB_GETREG(USB_DEVFIFOCFG1_REG_OFS);
				if ((FIFOCfg1Reg.bit.BLKNO_F5 == 0) && (FIFOCfg1Reg.bit.BLKSZ_F5))
					j = 2;
				else if ((FIFOCfg1Reg.bit.BLKNO_F5 == 1) && (FIFOCfg1Reg.bit.BLKSZ_F5))
					j = 4;
				else if (FIFOCfg1Reg.bit.BLKNO_F5 == 1)
					j = 2;
				else if ((FIFOCfg1Reg.bit.BLKNO_F5 == 2) && (FIFOCfg1Reg.bit.BLKSZ_F5))
					j = 6;
				else if (FIFOCfg1Reg.bit.BLKNO_F5 == 2)
					j = 3;
				else
					j = 1;
			}
		...
		case USB_FIFO6: {
				FIFOCfg1Reg.reg = USB_GETREG(USB_DEVFIFOCFG1_REG_OFS);
				if ((FIFOCfg1Reg.bit.BLKNO_F6 == 0) && (FIFOCfg1Reg.bit.BLKSZ_F6))
					j = 2;
				else if ((FIFOCfg1Reg.bit.BLKNO_F6 == 1) && (FIFOCfg1Reg.bit.BLKSZ_F6))
					j = 4;
				else if (FIFOCfg1Reg.bit.BLKNO_F6 == 1)
					j = 2;
				else if ((FIFOCfg1Reg.bit.BLKNO_F6 == 2) && (FIFOCfg1Reg.bit.BLKSZ_F6))
					j = 6;
				else if (FIFOCfg1Reg.bit.BLKNO_F6 == 2)
					j = 3;
				else
					j = 1;
			}
		...
		case USB_FIFO7: {
				FIFOCfg1Reg.reg = USB_GETREG(USB_DEVFIFOCFG1_REG_OFS);
				if ((FIFOCfg1Reg.bit.BLKNO_F7 == 0) && (FIFOCfg1Reg.bit.BLKSZ_F7))
					j = 2;
				else if ((FIFOCfg1Reg.bit.BLKNO_F7 == 1) && (FIFOCfg1Reg.bit.BLKSZ_F7))
					j = 4;
				else if (FIFOCfg1Reg.bit.BLKNO_F7 == 1)
					j = 2;
				else if ((FIFOCfg1Reg.bit.BLKNO_F7 == 2) && (FIFOCfg1Reg.bit.BLKSZ_F7))
					j = 6;
				else if (FIFOCfg1Reg.bit.BLKNO_F7 == 2)
					j = 3;
				else
					j = 1;
			}
		...
		case USB_FIFO8: {
				FIFOCfg2Reg.reg = USB_GETREG(USB_DEVFIFOCFG2_REG_OFS);
				if ((FIFOCfg2Reg.bit.BLKNO_F8 == 0) && (FIFOCfg2Reg.bit.BLKSZ_F8))
					j = 2;
				else if ((FIFOCfg2Reg.bit.BLKNO_F8 == 1) && (FIFOCfg2Reg.bit.BLKSZ_F8))
					j = 4;
				else if (FIFOCfg2Reg.bit.BLKNO_F8 == 1)
					j = 2;
				else if ((FIFOCfg2Reg.bit.BLKNO_F8 == 2) && (FIFOCfg2Reg.bit.BLKSZ_F8))
					j = 6;
				else if (FIFOCfg2Reg.bit.BLKNO_F8 == 2)
					j = 3;
				else
					j = 1;
			}
		...
		case USB_FIFO9: {
				FIFOCfg2Reg.reg = USB_GETREG(USB_DEVFIFOCFG2_REG_OFS);
				if ((FIFOCfg2Reg.bit.BLKNO_F9 == 0) && (FIFOCfg2Reg.bit.BLKSZ_F9))
					j = 2;
				else if ((FIFOCfg2Reg.bit.BLKNO_F9 == 1) && (FIFOCfg2Reg.bit.BLKSZ_F9))
					j = 4;
				else if (FIFOCfg2Reg.bit.BLKNO_F9 == 1)
					j = 2;
				else if ((FIFOCfg2Reg.bit.BLKNO_F9 == 2) && (FIFOCfg2Reg.bit.BLKSZ_F9))
					j = 6;
				else if (FIFOCfg2Reg.bit.BLKNO_F9 == 2)
					j = 3;
				else
					j = 1;
			}
		...
		case USB_FIFO10: {
				FIFOCfg2Reg.reg = USB_GETREG(USB_DEVFIFOCFG2_REG_OFS);
				if ((FIFOCfg2Reg.bit.BLKNO_F10 == 0) && (FIFOCfg2Reg.bit.BLKSZ_F10))
					j = 2;
				else if ((FIFOCfg2Reg.bit.BLKNO_F10 == 1) && (FIFOCfg2Reg.bit.BLKSZ_F10))
					j = 4;
				else if (FIFOCfg2Reg.bit.BLKNO_F10 == 1)
					j = 2;
				else if ((FIFOCfg2Reg.bit.BLKNO_F10 == 2) && (FIFOCfg2Reg.bit.BLKSZ_F10))
					j = 6;
				else if (FIFOCfg2Reg.bit.BLKNO_F10 == 2)
					j = 3;
				else
					j = 1;
			}
		...
		case USB_FIFO11: {
				FIFOCfg2Reg.reg = USB_GETREG(USB_DEVFIFOCFG2_REG_OFS);
				if ((FIFOCfg2Reg.bit.BLKNO_F11 == 0) && (FIFOCfg2Reg.bit.BLKSZ_F11))
					j = 2;
				else if ((FIFOCfg2Reg.bit.BLKNO_F11 == 1) && (FIFOCfg2Reg.bit.BLKSZ_F11))
					j = 4;
				else if (FIFOCfg2Reg.bit.BLKNO_F11 == 1)
					j = 2;
				else if ((FIFOCfg2Reg.bit.BLKNO_F11 == 2) && (FIFOCfg2Reg.bit.BLKSZ_F11))
					j = 6;
				else if (FIFOCfg2Reg.bit.BLKNO_F11 == 2)
					j = 3;
				else
					j = 1;
			}
		...
		case USB_FIFO12: {
				FIFOCfg3Reg.reg = USB_GETREG(USB_DEVFIFOCFG3_REG_OFS);
				if ((FIFOCfg3Reg.bit.BLKNO_F12 == 0) && (FIFOCfg3Reg.bit.BLKSZ_F12))
					j = 2;
				else if ((FIFOCfg3Reg.bit.BLKNO_F12 == 1) && (FIFOCfg3Reg.bit.BLKSZ_F12))
					j = 4;
				else if (FIFOCfg3Reg.bit.BLKNO_F12 == 1)
					j = 2;
				else if ((FIFOCfg3Reg.bit.BLKNO_F12 == 2) && (FIFOCfg3Reg.bit.BLKSZ_F12))
					j = 6;
				else if (FIFOCfg3Reg.bit.BLKNO_F12 == 2)
					j = 3;
				else
					j = 1;
			}
		...
		case USB_FIFO13: {
				FIFOCfg3Reg.reg = USB_GETREG(USB_DEVFIFOCFG3_REG_OFS);
				if ((FIFOCfg3Reg.bit.BLKNO_F13 == 0) && (FIFOCfg3Reg.bit.BLKSZ_F13))
					j = 2;
				else if ((FIFOCfg3Reg.bit.BLKNO_F13 == 1) && (FIFOCfg3Reg.bit.BLKSZ_F13))
					j = 4;
				else if (FIFOCfg3Reg.bit.BLKNO_F13 == 1)
					j = 2;
				else if ((FIFOCfg3Reg.bit.BLKNO_F13 == 2) && (FIFOCfg3Reg.bit.BLKSZ_F13))
					j = 6;
				else if (FIFOCfg3Reg.bit.BLKNO_F13 == 2)
					j = 3;
				else
					j = 1;
			}
		...
		case USB_FIFO14: {
				FIFOCfg3Reg.reg = USB_GETREG(USB_DEVFIFOCFG3_REG_OFS);
				if ((FIFOCfg3Reg.bit.BLKNO_F14 == 0) && (FIFOCfg3Reg.bit.BLKSZ_F14))
					j = 2;
				else if ((FIFOCfg3Reg.bit.BLKNO_F14 == 1) && (FIFOCfg3Reg.bit.BLKSZ_F14))
					j = 4;
				else if (FIFOCfg3Reg.bit.BLKNO_F14 == 1)
					j = 2;
				else if ((FIFOCfg3Reg.bit.BLKNO_F14 == 2) && (FIFOCfg3Reg.bit.BLKSZ_F14))
					j = 6;
				else if (FIFOCfg3Reg.bit.BLKNO_F14 == 2)
					j = 3;
				else
					j = 1;
			}
		...
		case USB_FIFO15: {
				FIFOCfg3Reg.reg = USB_GETREG(USB_DEVFIFOCFG3_REG_OFS);
				if ((FIFOCfg3Reg.bit.BLKNO_F15 == 0) && (FIFOCfg3Reg.bit.BLKSZ_F15))
					j = 2;
				else if ((FIFOCfg3Reg.bit.BLKNO_F15 == 1) && (FIFOCfg3Reg.bit.BLKSZ_F15))
					j = 4;
				else if (FIFOCfg3Reg.bit.BLKNO_F15 == 1)
					j = 2;
				else if ((FIFOCfg3Reg.bit.BLKNO_F15 == 2) && (FIFOCfg3Reg.bit.BLKSZ_F15))
					j = 6;
				else if (FIFOCfg3Reg.bit.BLKNO_F15 == 2)
					j = 3;
				else
					j = 1;
			}
	...
	if (fifonum < USB_FIFO_MAX) {
		...
		if (bAbortDMA) {
...
#if _USE_VDMA_FIFO_
			{
				...
				*pDMALen -= devVDMACXF1.bit.VDMA_LEN_CXF;
	...
	case USB_EP15:
		{
			...
			if (usb2dev_is_highspeed_enabled()) {
				...
				if (gUSBManage.ep_config_hs[EPn - 1].blk_size > 512) {
					...
					/*HBWx3 Ping-Pong case*/
					if ((gUSBManage.ep_config_hs[EPn - 1].blk_num == BLKNUM_TRIPLE) && (fifonum == FIFO0)) {
						uiBufNum = uiBufNum << 1;
					}
				}
			} else {
			...
			/*Check fifo count*/
			for (loop = 0; loop < uiBufNum; loop++) {
				if(fifonum < 4) {
					devFIFOByteCnt.reg = USB_GETREG(USB_DEVFIFO0BYTECNT_REG_OFS + ((fifonum) << 2));
				} else {
					devFIFOByteCnt.reg = USB_GETREG(USB_DEVFIFO4BYTECNT_REG_OFS + ((fifonum-4) << 2));
				}

				if (devFIFOByteCnt.bit.BC_F)
					return TRUE;
