...
int main(int argc, char *argv[])
{
	...
	while (trig) {
		...
		case 55:
			...
			printf("id = %d, la_width_scaling_factor=%d, la_height_scaling_factor=%d \r\n", afd_param.id, afd_param.afd_param.la_width_scaling_factor, afd_param.afd_param.la_height_scaling_factor);
			printf("y_lower_limit=%d, y_upper_limit=%d, fomi_thres=%d, foms_thres=%d, \r\n", afd_param.afd_param.y_lower_limit, afd_param.afd_param.y_upper_limit, afd_param.afd_param.fomi_thres, afd_param.afd_param.foms_thres);
			printf("fomi_thres_detblk=%d, foms_thres_detblk=%d \r\n", afd_param.afd_param.fomi_thres_detblk, afd_param.afd_param.foms_thres_detblk);
			printf("relative_strength_ratio=%d \r\n", afd_param.afd_param.relative_strength_ratio);
			printf("detect_50hz_thres=%d, detect_60hz_thres=%d \r\n", afd_param.afd_param.detect_50hz_thres, afd_param.afd_param.detect_60hz_thres);
			break;
		...
		case 87:
			...
			for(i=0; i< AEALG_DYNAMIC_LV_NUM; i++){
				shdr_hbs.shdr_hbs.hbs_adj_ratio[i] = 135;
			}
		...
		case 88:
			...
			do {
				printf("Set la_width_scaling_factor >> \n");
				afd_param.afd_param.la_width_scaling_factor = (UINT32)get_choose_int();
				printf("Set la_height_scaling_factor >> \n");
				afd_param.afd_param.la_height_scaling_factor = (UINT32)get_choose_int();
				printf("Set y_lower_limit >> \n");
				afd_param.afd_param.y_lower_limit = (UINT32)get_choose_int();
				printf("Set y_upper_limit >> \n");
				afd_param.afd_param.y_upper_limit = (UINT32)get_choose_int();
				printf("Set fomi_thres >> \n");
				afd_param.afd_param.fomi_thres = (UINT32)get_choose_int();
				printf("Set foms_thres >> \n");
				afd_param.afd_param.foms_thres = (UINT32)get_choose_int();
				printf("Set fomi_thres_detblk >> \n");
				afd_param.afd_param.fomi_thres_detblk = (UINT32)get_choose_int();
				printf("Set foms_thres_detblk >> \n");
				afd_param.afd_param.foms_thres_detblk = (UINT32)get_choose_int();
				printf("Set relative_strength_ratio >> \n");
				afd_param.afd_param.relative_strength_ratio = (UINT32)get_choose_int();
				printf("Set detect_50hz_thres >> \n");
				afd_param.afd_param.detect_50hz_thres = (UINT32)get_choose_int();
				printf("Set detect_60hz_thres >> \n");
				afd_param.afd_param.detect_60hz_thres = (UINT32)get_choose_int();
			} while (0);

			vendor_isp_set_ae(AET_ITEM_AFD_PARAM, &afd_param);
			printf("id = %d, la_width_scaling_factor = %d \n", afd_param.id, afd_param.afd_param.la_width_scaling_factor);
			break;
