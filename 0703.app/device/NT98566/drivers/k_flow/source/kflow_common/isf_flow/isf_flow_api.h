...
#define ISF_COMM_CFG_MULTIPROC	0x80
#define ISF_MULTIPROC_ID_SERVER	0x00

extern UINT32 isf_get_common_cfg(void);
extern UINT32 isf_get_cfg(UINT32 h_isf);
...
///////////////////////////////////////////////////////////////////////////////
extern ISF_RV isf_unit_set_param(UINT32 h_isf, UINT32 unit_nport, UINT32 param, UINT32 value);
extern ISF_RV isf_unit_get_param(UINT32 h_isf, UINT32 unit_nport, UINT32 param, UINT32* p_value);
extern ISF_RV isf_unit_set_struct(UINT32 h_isf, UINT32 unit_nport, UINT32 param, UINT32* p_struct, UINT32 size);
extern ISF_RV isf_unit_get_struct(UINT32 h_isf, UINT32 unit_nport, UINT32 param, UINT32* p_struct, UINT32 size);

///////////////////////////////////////////////////////////////////////////////
extern ISF_RV isf_unit_set_bind(UINT32 h_isf, UINT32 this_oport, UINT32 dest_iport);
extern ISF_RV isf_unit_get_bind(UINT32 h_isf, UINT32 this_oport, UINT32* dest_iport);
extern ISF_RV isf_unit_set_state(UINT32 h_isf, UINT32 this_oport, UINT32 state);
extern ISF_RV isf_unit_get_state(UINT32 h_isf, UINT32 this_oport, UINT32* state);
