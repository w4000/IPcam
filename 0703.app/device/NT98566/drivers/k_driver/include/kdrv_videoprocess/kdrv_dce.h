...
*/
typedef struct{
	UINT32 dce_frm_ed_cnt;
	UINT32 dce_frm_st_cnt;
	UINT32 dce_ll_ed_cnt;
	UINT32 dce_strp_err_cnt;
	UINT32 dce_bufovfl_cnt;
	UINT32 dce_strp_bund_ovfl_cnt;
	UINT32 dce_Yback_err_cnt;
	UINT32 dce_ll_err_cnt;
	UINT32 dce_ll_err2_cnt;
	UINT32 dce_frm_err_cnt;
}KDRV_DCE_DBG_INFO;
...
typedef struct {
	UINT32 cnn_sram_en;
} KDRV_DCE_MODULE_INIT;

INT32 kdrv_dce_module_init(KDRV_DCE_MODULE_INIT *info);
