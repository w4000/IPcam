...
/**
    Reset USB controller fifo configuration

    This API will reset USB controller fifo configuration.

    @return
        - @b E_OK: reset configuration success
        - @b E_SYS: reset configuration fail
*/
extern ER                   usb2dev_reset_fifo_config(void);
