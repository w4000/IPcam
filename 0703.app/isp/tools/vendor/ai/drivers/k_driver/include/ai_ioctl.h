...
typedef struct ai_drv_runllinfo {
	KDRV_AI_LL_INFO info;
	KDRV_AI_TRIGGER_PARAM trig_parm;
	KDRV_AI_ENG engine;
	UINT32 net_id;
...
typedef struct _AI_DRV_ENG_DBG_INFO {
	UINT32 eng_prof_en;
	UINT32 reserved[7];
} AI_DRV_ENG_DBG_INFO;

typedef struct _AI_DRV_ENG_QUERY_INFO {
	UINT32 eng_time;
	UINT32 eng_util;
	UINT32 reserved[6];
} AI_DRV_ENG_QUERY_INFO;

typedef struct _AI_DRV_USR_ENG_INFO {
	AI_DRV_ENG_QUERY_INFO cnn1_info;
	AI_DRV_ENG_QUERY_INFO cnn2_info;
	AI_DRV_ENG_QUERY_INFO nue_info;
	AI_DRV_ENG_QUERY_INFO nue2_info;
} AI_DRV_USR_ENG_INFO;

typedef struct _AI_DRV_USR_DBG_INFO {
	AI_DRV_ENG_DBG_INFO cnn1_info;
	AI_DRV_ENG_DBG_INFO cnn2_info;
	AI_DRV_ENG_DBG_INFO nue_info;
	AI_DRV_ENG_DBG_INFO nue2_info;
} AI_DRV_USR_DBG_INFO;
//============================================================================
// IOCTL command
//============================================================================
...
#define AI_IOC_RUN_LL					_VOS_IOWR(AI_IOC_COMMON_TYPE, 40, void*)

#define AI_IOC_SET_DBG_INFO			    _VOS_IOWR(AI_IOC_COMMON_TYPE, 41, AI_DRV_USR_DBG_INFO*)
#define AI_IOC_GET_ENG_INFO			    _VOS_IOWR(AI_IOC_COMMON_TYPE, 42, AI_DRV_USR_ENG_INFO*)

#if KDRV_AI_SUPPORT_NUELL
#define NUE_IOC_SET_LL_CMD			    _VOS_IOWR(AI_IOC_COMMON_TYPE, 43, void*)
#define NUE_IOC_RUN_FC_LL			    _VOS_IOWR(AI_IOC_COMMON_TYPE, 44, void*)
#define NUE_IOC_GET_PARM_SIZE			_VOS_IOWR(AI_IOC_COMMON_TYPE, 45, void*)
#endif
