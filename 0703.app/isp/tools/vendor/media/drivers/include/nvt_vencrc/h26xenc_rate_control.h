...
0.1.63.1: EVBR initial state by user input
*/
#define H26X_RC_VERSION     0x00013F01
#define H26X_RC_VER_STR		"0.1.63.1"
...
#define WEIGHT_CAL_RESET            3    //1: fix weight  2:fix weight+min alpha    3: fix weight+alpha reset
