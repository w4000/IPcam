...
#define TSK_PRI_USBCTRL        8
#define TSK_PRI_USBSETUP       8
...
// Add function for setting the release number in USB device descriptor
extern UINT16           gUSBHSDevRelNum;
extern UINT16           gUSBFSDevRelNum;
