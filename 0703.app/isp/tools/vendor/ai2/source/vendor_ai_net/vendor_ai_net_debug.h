...
extern UINT32 vendor_ai_net_get_trace(UINT32 proc_id);
...
extern HD_RESULT vendor_ai_net_debug_get_memsize(UINT32 proc_id, UINT32* p_model_size, UINT32* p_initbuf_size, UINT32* p_workbuf_size);
