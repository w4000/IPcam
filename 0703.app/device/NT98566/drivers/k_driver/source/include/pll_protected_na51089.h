...
typedef enum {
	...
	//2022/2/11
	PLL_CLKSEL_UVCP =	    PLL_CLKSEL_R3_OFFSET + 14,  //< Clock Select Module ID: UVCP
...
typedef enum {
	...
	CNNCLK_FREQ,			///< CNN   	CLK Select ID
	IVECLK_FREQ,			///< IVE   	CLK Select ID
	IPECLK_FREQ,			///< IPE   	CLK Select ID
	DISCLK_FREQ,			///< DIS   	CLK Select ID
