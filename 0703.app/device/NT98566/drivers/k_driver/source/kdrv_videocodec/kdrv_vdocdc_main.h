...
//#define H26XE_VER_STR			"0.3.9"	/*(2021/08/11): romove no-used param all_job_done */
//#define H26XE_VER_STR			"0.3.10"	/*(2022/02/25): update gdr behavior (IVOT_N12089_CO-1245)*/
#define H26XE_VER_STR			"0.3.11"	/*(2022/03/02): support sei payload for bs checksum (IVOT_N12089_CO-1350)*/
